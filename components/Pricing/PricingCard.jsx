...
export function PricingCard({ name, price, benefits, isSelected, onSelect }) {
  return (
    <div
    ...
    >
      ...
      <p className="text-4xl font-bold text-white mb-6">{price}<span className="text-lg font-normal">/month</span></p>
